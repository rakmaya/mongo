...
/**
 * Creates the peripheral collections required for HCIndex to encode and decode
 * metadata efficiently. These collections are created in the same database as
 * the timeseries collection. Reutrns OK on success, or an error status if
